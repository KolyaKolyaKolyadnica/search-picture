...
- Создан репозиторий `js-hw-13-image-finder`.
- Добавить [человечка](https://github.com/HennadiiMariiev) в Contributors
- главная ветка _main_ **ПУСТАЯ**, всю работу делаем в ветке _dev_
- по завершению ДЗ создаем _Pull Request_ в ветку _main_

- При сдаче домашней работы есть ссылка на рабочую страницу на GitHub pages
  (ccылку добавить в секции _About_ в корне репозитория)
- [Как деплоить билд на gh-pages](https://drive.google.com/file/d/13LVUU_eNGXTRiv8eiBNTkomIHrBMUx3e/view)
...
- **ЭТО ФИНАЛЬНАЯ ДОМАШНЯЯ РАБОТА В КУРСЕ JS, СДЕЛАЙ ЕЕ КАК ДЛЯ СВОЕГО ПОРТФОЛИО**
